...
zt =  262.7 + 11.65*cos(t*1.496) - 63.16*sin(t*1.496) - 33.56*cos(2*t*1.496) + 82.36*sin(2*t*1.496) - 38.04*cos(3*t*1.496) + 23.7*sin(3*t*1.496) - 14.84*cos(4*t*1.496) - 8.802*sin(4*t*1.496) - 7.894*cos(5*t*1.496) - 4.65*sin(5*t*1.496) - 6.884*cos(6*t*1.496) - 6.088*sin(6*t*1.496) + 2.615*cos(7*t*1.496) - 3.547*sin(7*t*1.496) - 1.716*cos(8*t*1.496) + 1.293*sin(8*t*1.496);
